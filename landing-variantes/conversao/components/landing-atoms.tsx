 ...
 *
 * NA VARIANTE "CONVERSÃO" ESTE ARQUIVO NÃO É IMPORTADO POR NINGUÉM.
 * Ele existe aqui só para que as duas variantes tenham o mesmo conjunto de
 * arquivos e a troca possa ser feita por sobrescrita, sem apagar nada.
 *
